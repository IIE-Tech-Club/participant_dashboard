...
export default function LandingPage() {
  ...
  const features = [
    ...
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 20h5v-2a3 3 0 00-5.856-1.487M15 10a3 3 0 11-6 0 3 3 0 016 0zM16 20a3 3 0 11-6 0 3 3 0 016 0z" />
        </svg>
      ),
    ...
    >
      ...
      <section className="relative min-h-[calc(100vh-64px)] flex items-center px-4 sm:px-6 lg:px-8 py-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 lg:col-span-7">
            {/* Badge */}
            <div ref={badgeRef} className="inline-flex items-center gap-2.5 px-3 py-1.5 rounded-full border border-purple-500/15 bg-purple-500/5 backdrop-blur-sm">
            ...
            {/* Subtitle */}
            <p ref={subRef} className="font-grotesk text-sm sm:text-base md:text-lg text-[rgba(241,240,255,0.6)] max-w-lg leading-relaxed flex items-start gap-4">
          ...
          <div ref={cardRef} className="w-full max-w-sm mx-auto lg:col-span-5 relative z-10">
              ...
              <div className="glass-card relative p-6 sm:p-8 border-purple-500/20 overflow-visible rounded-2xl bg-[#0f0f24]/50 backdrop-blur-2xl">
                ...
                <div className="text-center mb-8">
                  <div className="mx-auto mb-4 w-12 h-12 flex items-center justify-center relative rounded-xl bg-purple-500/5 border border-purple-500/20">
                    <svg className="relative z-10 w-5 h-5 text-purple-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12L11 14L15 10M12 3C7 3 3 7 3 12C3 17 7 21 12 21C17 21 21 17 21 12C21 7 17 3 12 3Z" />
                    </svg>
                  </div>
                ...
                {error && (
                  <div className="mb-5">
                    <ErrorAlert title="Connection Failed" message={error} onRetry={() => setError(null)} />
                  </div>
                )}
                ...
                <div className="flex items-center gap-3 my-5">
                  ...
                  <span className="font-mono-cc text-[8px] text-[rgba(241,240,255,0.2)] uppercase tracking-[0.25em]">Secure Uplink</span>
                  <div className="flex-1 h-px bg-purple-500/10" />
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-14 sm:mb-20 space-y-4">
            <div className="inline-flex items-center gap-2.5 px-3 py-1.5 rounded-full border border-purple-500/15 bg-purple-500/5">
              <span className="w-1.5 h-1.5 rounded-full bg-pink-500 animate-pulse-dot" />
              <span className="font-orbitron font-bold text-[9px] text-purple-300 uppercase tracking-widest">Workspace Features</span>
            </div>
            ...
            <p className="font-grotesk text-sm sm:text-base text-[rgba(241,240,255,0.5)] max-w-xl mx-auto leading-relaxed">
              Equipped with elite resources to help you ideate, build, and deploy high-impact software projects
            </p>
          </div>
      ...
      <section className="relative py-20 sm:py-32 px-4 sm:px-6 lg:px-8 border-t border-white/[0.04]">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <div className="inline-flex items-center gap-2.5 px-3 py-1.5 rounded-full border border-purple-500/15 bg-purple-500/5">
            <span className="w-1.5 h-1.5 rounded-full bg-pink-500 animate-pulse-dot" />
            <span className="font-orbitron font-bold text-[9px] text-purple-300 uppercase tracking-widest">Join Today</span>
          </div>
          ...
          <p className="font-grotesk text-sm sm:text-base text-[rgba(241,240,255,0.55)] max-w-xl mx-auto leading-relaxed">
            Register now to join the upcoming cohort of developers, designers, and innovators. Shape the future in our next collaborative sprint.
          </p>
      ...
      {/* ── Footer ── */}
      <footer className="border-t border-white/[0.04] bg-[#05050a]/40 backdrop-blur-sm py-8 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-6 h-6 rounded border border-purple-500/20 flex items-center justify-center bg-purple-500/[0.02]">
              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#c084fc" strokeWidth="2.5">
                <polygon points="12 2 22 8.5 22 15.5 12 22 2 15.5 2 8.5 12 2" />
              </svg>
            </div>
            <span className="font-orbitron font-bold text-xs text-white uppercase tracking-wider">IIE Tech Club</span>
          </div>
          <p className="font-mono-cc text-[10px] text-[rgba(241,240,255,0.3)]">
            © 2026 CodeCraft. Engineered by IIE Tech Club.
          </p>
          <div className="flex gap-6">
            {["Status", "Careers", "Contact"].map((link) => (
              <a key={link} href="#" className="font-mono-cc text-[9.5px] text-[rgba(241,240,255,0.4)] hover:text-purple-300 transition-colors uppercase tracking-widest font-semibold">
                {link}
              </a>
            ))}
          </div>
